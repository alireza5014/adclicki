        ...
        <div id="internal-content" class="col-md-9 pull-md-left">
            ...
            <div id="replyform" class="panel panel-pink panel-collapsable hidden-print panel-collapsed">
                ...
                <div id="replybody" class="panel-body panel-body-collapsed" style="display: none;">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="{{route('save_ticket',['id'=>$tickets->id])}}" enctype="multipart/form-data" id="insert_ticket_answer"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control disabled" type="text" id="inputName" value="{{auth()->user()->fname." ".auth()->user()->lname}}"
             ...
             @foreach($tickets->tickets_answers as $ticket)
                ...
                @elseif($ticket->sender_type==0)
                    ...
                    <div class="panel panel-info ticket-reply markdown-content">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-user"></i>  {{$tickets->user->fname." ".$tickets->user->lanme}} (مشتری){{$tickets->user->id}}
                                <div class="date pull-right">
                                    {{$ticket->created_at}}
