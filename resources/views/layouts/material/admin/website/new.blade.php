        ...
        <div class="container">
            ...
            <div class="row group">
                ...
                <div class="col-sm-6">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.website.create') }}"
                          enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="form-group form-group--float">
                            <input dir="ltr" id="user_id" type="text"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-group--float">
                                <select id="status" type="text"
                                    ...
                                    <option value="1"> فعال و تایید شده</option>
                                    <option  value="2">    رد شده
                                    </option>
