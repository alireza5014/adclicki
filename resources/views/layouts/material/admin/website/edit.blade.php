...
@section('content')
    ...
    <div class="card">
        ...
        <a href="{{route('admin.website.list')}}" class="btn btn-success btn-xs">
            لیست سایت های من </a>
    </div>
    <div class="card">
            ...
            <div class="row group">
                ...
                <div class="col-sm-6">
                    ...
                    <form class="form-horizontal" role="form" method="POST"
                          action="{{ route('admin.website.modify',['id'=>$website->id]) }}"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-group--float">
                                <select id="type" type="text"
                                    ...
                                    <option @if($website->type=='pop_box') selected @endif value="pop_box"> پاپ باکس
                                    </option>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-group--float">
                                <select id="status" type="text"
                                    ...
                                    <option @if($website->status==0) selected @endif value="0"> در حال بررسی</option>
                                    <option @if($website->status==1) selected @endif value="1"> فعال و تایید شده</option>
                                    <option @if($website->status==2) selected @endif value="2">    رد شده
                                    </option>
