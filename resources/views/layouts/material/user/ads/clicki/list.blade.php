                    ...
                    <div class="container">
                        ...
                        <form id="view_request_form" class="form-horizontal" action="action_page.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select type="text" class="form-control input-sm" id="buy_type" name="buy_type"
                                          >
                                        <option value="1">تخصیص از موجودی کلیک من</option>
                                        <option value="2">تخصیص از موجودی کل من</option>
                                    </select>
...
" <p>  برای نمایش و بازدید آگهی شما در سایت می بایست از قسمت <code>[ تخصیص کلیک ]</code> کلیک های مورد نظر خود را به آگهی خود اختصاص دهید <p>
   ...
   "])@endcomponent
    ...
    <div class="card">
        ...
        <a href="{{route('user.ads.clicki.new')}}" class="btn btn-success btn-xs">ثبت تبلیغ کلیکی
              جدبد</a>
    </div>
    ...
    <div class="card">
            ...
            <div class="card-block">
                ...
                @include('layouts.material.user.ads.clicki.table')
                ...
                $('#view_request_btn').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#view_request_message').html('').append(data.message);
                        },
