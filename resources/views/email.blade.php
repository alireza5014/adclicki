...
<body style="background-color: #e9ecef;" dir="rtl">
                ...
                <tr>
                    <td align="center" valign="top" style="padding: 36px 24px;">
                        <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                            <img src="https://www.adclicki.ir/logo.png" alt="Logo" border="0" width="100%" style="display: block; width: 100%px; max-width: 100%; min-width: 48px;">
                        </a>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="right" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">If that doesn't work, شثصقنکمبت and paste the following link in your browser:</p>
