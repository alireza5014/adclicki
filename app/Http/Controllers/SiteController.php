...
//        sendMessageToAdmin($email . "\n" . ' وارد حساب کاربری خود شد ');
    ...
    {
//       return ImageUpload::makeImageWithText2(" سنگ نوشته هایی به جای مانده از هزاران سال قبل و همچنین خانه های تاریخی این روستا، از جمله جاذبه های تاریخی موجود در آن alireza .", "images/test.png");
       return ImageUpload::makeImageWithText2(" Wrapper for PHP's GD Library for easy image manipulation to resize, crop and draw images on top of each other preserving transparency, .", "images/test.png");
exit();
